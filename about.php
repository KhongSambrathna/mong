...
<div class="container battambang text-justify">
    <div class="row">
        <div class="col-xl-7">
            <article class="article">
                <!-- រចនាសម្ព័ន្ធគ្រប់គ្រង -->
                <a name="structure"></a>
                <h4 class="koulen text-center">រចនាសម្ព័ន្ធគ្រប់គ្រង</h4>
                <img class="w-100" src="img/management_system.png" alt="School management">
                <!-- ចក្ខុវិស័យ -->
                <a name="vision"></a>
                <h4 class="koulen text-center">ចក្ខុវិស័យ</h4>
                <p>
                ...
                <a name="mission"></a>
                <h4 class="koulen text-center">បេសកកម្ម</h4>
                <p>
        ...
        <div class="col-xl-5">
            <article class="article">
                ...
                <!--ប្លង់សាលារៀន-->
                <h4 class="koulen text-center">ប្លង់សាលារៀន</h4>
                <img class="w-100" src="img/logo/monglayout.png" alt="layout">
            </article>
        </div>
    </div>
</div>
